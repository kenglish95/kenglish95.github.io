...
Alongside Nicola Rennie I ran the following workshop:
...
### [LGBT History Month Rainbow Trap Talk: University of Glasgow]{style="color:#FF00CC "}

###### Feburary 2026

Chaired Dr Kevin Guyan's talk about his book Rainbow Trap.

### [Queer in a Wee Place Launch Event: University of Strathclyde]{style="color:#FF00CC "}
...
### [Facilitator for the in conversation with the Deans panel at the CoSS Connections event: University of Glasgow]{style="color:#FF00CC "}
...
# [2024 Events]{style="color:#FF00CC "}

<details>

<summary>Click to read</summary>

### [Who counts?: Barriers to participation with the Scottish Budget and data representation: SHRC & SGSSS]{style="color:#FF00CC "}
...
### [The construction of Scotland’s LGBTQ+ population in the census : University of Starthclyde]{style="color:#FF00CC "}

###### December 2024

Talked about how the Scottish 2022 census did and did not represent LGBTQ+ people at the Queer in A Wee Place book event.

### [Queering Data Production: NCRM]{style="color:#FF00CC "}
...
### [Queer Data Production: SGSSS]{style="color:#FF00CC "}
...
# [2022 Events]{style="color:#FF00CC "}

<details>

<summary>Click to read</summary>

### [Binary barriers: Representing trans & gender diverse populations in censuses & other population surveys: Mind the Gap Conference]{style="color:#FF00CC "}
...
### [LGBTQ Data Summit: University of Glasgow]{style="color:#FF00CC "}
...
### [Will the digital ever be non-binary? The future of trans (data) rights: Computers, Privacy & Data Protection (CPDP)]{style="color:#FF00CC "}
...
### [Queer Data Launch: Data as a tool for social justice : Lighthouse Bookshop Edinburgh]{style="color:#FF00CC "}
...
# [2021 Events]{style="color:#FF00CC "}

<details>

<summary>Click to read</summary>

### [Reframing census debates: Essential criteria for representing trans people:Beyond the binary variable conference: FemQuants]{style="color:#FF00CC "}
...
### [Conducting Research with LGBTQ+ People: SGSSS]{style="color:#FF00CC "}

###### June 2021

A twice repeated 3 hour workshop for the SGSSS summer school

### [What will the census tell us?: Working with and representing LGBTQ+ people: University of Brighton’s Centre for Transforming Sexuality and Gender]{style="color:#FF00CC "}
...
# [2020 Events]{style="color:#FF00CC "}

<details>

<summary>Click to read</summary>

### [Conducting Research with LGBTQ+ People Using Online Resources: SGSSS]{style="color:#FF00CC "}
...
### [Improving how population surveys represent, sex,gender and seuxality in the UK: Glasgow ReproducibiliTea]{style="color:#FF00CC "}

###### 24th July 2020

Presentation can be found [`here`](https://www.youtube.com/watch?v=SNNzXhIWA0I&ab_channel=GlasgowReproducibiliTea)

### [LGBTQ+ Reserach Sharing Event: University of Glasgow LGBT+ Staff Network]{style="color:#FF00CC "}

###### 18th June 2020

More information can be found [`here`](https://www.facebook.com/events/679643939546338/)

### [LGBT Reserach Sharing Event: University of Glasgow Gilchrist Postgraduate Club]{style="color:#FF00CC "}
